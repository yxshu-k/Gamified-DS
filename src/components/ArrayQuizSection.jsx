...
import questionsData from "../data/arrayQuestions.json";
import { leaderboardAPI } from "../utils/api";
import { useAuth } from "../context/AuthContext";

export default function ArrayQuizSection({ topic = "Array" }) {
  ...
  if (showResult) {
    ...
    const message =
      score >= 8
        ? "🔥 Excellent! You're mastering Array concepts like a pro!"
        : score >= 5
